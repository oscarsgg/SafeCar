...
import { collection, getDocs, query, where, getCountFromServer, orderBy, limit, collectionGroup } from 'firebase/firestore';
    ...
    try {
      ...
      if (latestClaimData) {
        ...
        setLatestClaim({
          ...
          description: latestClaimData.descripcion || INCIDENT_TYPES[latestClaimData.tipoSiniestro]?.name || latestClaimData.tipoSiniestro || "Reclamo sin descripción",
              ...
              <HStack space={4} alignItems="center">
                ...
                <VStack flex={1}>
                  ...
                  <HStack alignItems="center" space={2} mt={1}>
                    <Progress 
                      value={getProgressValue(latestClaim.status)} 
                      size="xs" 
                      flex={1} 
                      colorScheme="blue"
                    />
        ...
        >
          ...
          <VStack space={4}>
            <HStack justifyContent="space-between" alignItems="center">
              ...
              <Text fontWeight="bold" color={primaryColor}>{stats.totalUsers}</Text>
            </HStack>
            <HStack justifyContent="space-between" alignItems="center">
              <Text color={textColor}>Pólizas activas</Text>
              <Text fontWeight="bold" color={primaryColor}>{stats.totalPolicies}</Text>
            </HStack>
            <HStack justifyContent="space-between" alignItems="center">
              <Text color={textColor}>Reclamos pendientes</Text>
              <Text fontWeight="bold" color="orange.500">{stats.totalClaims}</Text>
            </HStack>
            <HStack justifyContent="space-between" alignItems="center">
              <Text color={textColor}>Nuevos usuarios este mes</Text>
              <Text fontWeight="bold" color="green.500">{stats.newUsersThisMonth}</Text>
            </HStack>
          </VStack>
        </Box>
